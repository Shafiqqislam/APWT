<html>
    ...
    <body>
        ...
        <a class="btn btn btn-secondary" href="{{route('service')}}">Service</a>
        <a class="btn btn-info" href="{{route('team')}}">Our teams</a>
        <a class="btn btn-dark" href="{{route('about')}}">About Us</a>
